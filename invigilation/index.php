...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800 text-center">INVIGILATION MANAGEMENT</h1>
<div>
    <?php  
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <?php
                        $sql1="select * from tbl_invigilation";
                        ...
                        <td style="justify-content:center; text-align:center" width="5%"> 
                            <input  type="checkbox"  style="vertical-align:bottom;width:14px;height:15px" class="checkbox-child" name="check_list[]"  value=<?php echo $row['invigilationid']; ?> >           
                        </td>
                        
                        </form>
                        
                        <!--Column Values -->
                        <?php  $sql2="select fName from tbl_faculty where fid in (select fid from tbl_invigilation where fid=$fid)"; 
                    ...
                    ?>
                        <?php
                        $dayofweek = array("1"=>"Monday","2"=>"Tuesday","3"=>"Wednesday","4"=>"Thursday","5"=>"Friday","6"=>"Saturday");
                        $date=strtotime($row['date']);
                        $day=date('w',$date);
                        ?>
                        <td style="justify-content:center; text-align:center" width="20%"> <?php echo date("d-m-Y",strtotime($row["date"])); ?> </td>
                        <td style="justify-content:center; text-align:center" width="20%"> <?php echo $dayofweek[$day]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="20%"> <?php echo $row["session"]; ?> </td>
