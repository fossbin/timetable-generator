<?php 
	...
	if (isset($_POST["submit"]))
	{
        ...
        $day=$dayofweek[date('w',strtotime($date))];

        $session = $_POST['session'];
           
            
        $sql = "insert into tbl_invigilation (fid,date,day,session) VALUES ($fid,'$date','$day','$session')";
        if($db->query($sql) == TRUE)
        { 
                $_SESSION['msg'] = "Invigilation duty added successfully!";
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group">
											...
											<div class="form-group">
                                                ...
                                                <input type="date" autofocus name="date" class="form-control"  required />
                                            ...
                                            <!-- <div class="form-group">
												<label for="exampleInputEmail1">Select session</label><br>
                                               <td>
