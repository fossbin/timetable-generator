<?php 
    ...
    $invid = $_GET['invid'];
    $sql1="select * from tbl_invigilation where invigilationid=$invid";
	...
	{    
           ...
           // $newpid=$_POST['pName'];
            ...
            $newsession=$_POST['session'];
                ...
                $sql = "update tbl_invigilation set fid = '$newfid',date = '$newdate',day = '$newday',session= '$newsession' where invigilationid = '$invid'";
