								...
								<div class="card mt-4  bg-white	">
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" autofocus name="fName" class="form-control" placeholder="Name" required />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $designation = array('Principal',"Vice Principal","Head of Department","Professor","Asst. Professor","Guest Lecturer","Librarian");
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus name="fQualification" class="form-control" placeholder="Qualification" required />
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Enter Email</label>
                                                <input type="email" autofocus name="fEmail" class="form-control" placeholder="Email" required />
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Enter Phone Number</label>
                                                <input type="phone" autofocus name="fPhone" class="form-control" placeholder="Phone Number" required />
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Select Gender</label><br>
                                               <td>
                                               <input type="radio" name="fGender" value="m"/>Male
                                                <input type="radio" name="fGender" value="f"/>Female
                                                </td>
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Enter the number of subjects</label>
                                                <input type="int" autofocus name="fSubcount" class="form-control" placeholder="No of subjects" required />
											</div>
