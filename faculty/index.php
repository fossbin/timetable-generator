...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800 text-center">FACULTY MANAGEMENT</h1>
<div>
    <?php  
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <?php
                        $sql1="select * from tbl_faculty order by fName";
                        ...
                        <tr>
                            ...
                            <th style="text-align:center;"><b>Info</b></th>
                        ...
                        <td style="justify-content:center; text-align:center" width="5%"> 
                            <input  type="checkbox"  style="vertical-align:bottom;width:14px;height:15px" class="checkbox-child" name="check_list[]"  value=<?php echo $row['fid']; ?> >
                                  
                        </td>
                        
                        </form>
                        
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["fName"]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["fDesignation"]; ?> </td>
                       
                        <td style="justify-content:center;padding-top:8px; text-align:center" width="10%"> 
                            <?php 
                                if($row["fStatus"]==1) {?>
                        ...
                        <td style="justify-content:center; text-align:center" width="10%"> 
                            <a href="view.php?fid=<?php echo $row['fid']?>"  style="background-color:white;" class="btn btn-light a-btn-slide-text">
                            <span style="color:gray" class="glyphicon glyphicon-edit fa fa-info-circle" aria-hidden="true"></span>
                            </a>
                        </td>
                         <!-- Edit button -->
                         <td style="justify-content:center; text-align:center" width="10%"> 
                            <a href="edit.php?fid=<?php echo $row['fid']?>"  style="background-color:white;" class="btn btn-light a-btn-slide-text">
                            <span style="color:orange" class="glyphicon glyphicon-edit fas fa-user-edit" aria-hidden="true"></span>
                            </a>
                        </td>
                        <!-- Delete button -->
                        <td style="justify-content:center; text-align:center" width="10%"> 
                            <a href="delete.php?id=<?php echo $row['fid']; ?>" onclick="return confirm('Are you sure you want to delete?')" 
