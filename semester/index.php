...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800 text-center">SEMESTER MANAGEMENT</h1>
<div>
    <?php  
        ...
        <?php
                        ...
                        <tr>
                            ...
                            <td style="justify-content:center; text-align:center" width="5%"> 
                                <input  type="checkbox"  style="vertical-align:bottom;width:14px;height:15px" class="checkbox-child" name="check_list[]"  value=<?php echo $row['semid']; ?> >
                                    
                            </td>
                            
                            </form>
                            
                            <td style="justify-content:center; text-align:center" width="50%"> <?php echo $row["semName"]; ?> </td>
                            ...
                            <td style="justify-content:center; text-align:center" width="10%"> 
                                <a href="edit.php?name=<?php echo $row['semName']?>"  style="background-color:white;" class="btn btn-light a-btn-slide-text">
                            ...
                            <!-- Delete button -->
                            <td style="justify-content:center; text-align:center" width="10%"> 
                                <a href="delete.php?id=<?php echo $row['semid']; ?>" onclick="return confirm('Are you sure you want to delete?')" 
