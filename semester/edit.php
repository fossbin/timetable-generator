<?php 
	...
	if (isset($_POST["submit"]))
	{
        ...
        { 
            ...
            $sql_select = "select * from tbl_semester where semName='$sname_new'";
            ...
            {
                $sname = $_GET['name'];
                $sql = "update tbl_semester set semName = '$sname_new' where semName = '$sname'";
...
<body id="page-top">
  ...
  <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../subjectallocation/php" >
									...
									<div class="card-body">
										<form action="" method="POST">
											<div class="form-group">
                                                ...
                                                <input type="text" autofocus name="sName" class="form-control" placeholder=" <?php echo $_GET['name']; ?>" required />
