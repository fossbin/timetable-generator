<?php 
	...
	{
        if($_POST["sid"]!=" " && $_POST["semName"]!=" ")
        { 
            $sname = $_POST['semName'];
            $sid = $_POST['sid'];
            
            //if name already exists print error message else insert
            $sql_select = "select * from tbl_semester where semid='$sid'";
            $result = $db->query($sql_select);
            if($result->num_rows)
            {
                ?> 
                <script> alert("Semester already exists!"); </script>
                <?php
                
            }
            else
            {
                $sql = "insert into tbl_semester(semid,semName) values($sid,'$sname')";
        ...
        else if($_POST["sid"]=" " && $_POST["semName"]!=" ")
        { ?> 
          <script> alert("Semester is empty!! "); </script>
          <?php 
        } 
        else if($_POST["sid"]!=" " && $_POST["semName"]=" ")
        { ?> 
            <script> alert("Semester name is empty!! "); </script>
            <?php 
        }
        else
        { ?> 
									...
									<div class="card-body">
										<form action="" method="POST">
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="text" autofocus name="sid" class="form-control" placeholder="Semester" required /> -->
											</div>
											<div class="form-group">
                                                ...
                                                <!-- <input type="text" autofocus name="semName" class="form-control" placeholder="Semester name" required /> -->
											</div>
