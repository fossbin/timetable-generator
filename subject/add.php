<?php 
    ...
    if(isset($_POST["submit"]))
	{
        ...
        $sem = $_POST["semid"];
        $hours = $_POST["hrs"];
                $sql_subject = "insert into tbl_subject(subname,subtype,pid,semid,subcount) VALUES ('$subname',$subtype,$program,$sem,$hours) ";
									...
									<div class="card-body">
										<form action="" method="POST">
											<div class="form-group">
                                                ...
                                                <input type="text" autofocus name="subname" class="form-control" placeholder="Subject" required />
											</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                {
                                                ?>
                                                <option value="<?php echo $i; ?>"><?php if($i==1) echo "Theory"; else if($i==0) echo "Practicals"; ?></option>
                                                <?php
                                                }
                                                ?>
                                                </select>
                                                <!-- <td>
                                                <input type="radio" name="subtype" value="1"/>Theory <br>
                                                <input type="radio" name="subtype" value="0"/>Practical	 -->
											</div>
                                                <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="int" autofocus name="semid" class="form-control" placeholder="" required /> -->
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Select Hours per Week</label>
