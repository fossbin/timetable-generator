<?php 
    ...
    $subid = $_GET['subid'];
    $sql1="select * from tbl_subject where subid=$subid";
    ...
    { 
        while($row =$result1->fetch_assoc())
        {
            ...
            $newsubid=$row['subid'];  
            $newsubname=$row['subname'];
            $newsubtype=$row['subtype'];
            $newpid=$row['pid'];
            $newsemid=$row['semid'];
            $newhours=$row['subcount'];
	...
	{    
        ...
        $newhours=$_POST['hrs'];
                ...
                $sql = "update tbl_subject set subname='$newsubname',subtype='$newsubtype',pid='$newpid',semid='$newsemid', subcount=$newhours where subid='$subid'";
								...
								<div class="card mt-4  bg-white	">
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group">
                                               ...
                                               <!-- <input type="text" autofocus name="bName" class="form-control" placeholder="<?php echo $subname; ?>" required />-->
                                                <input type="text" autofocus name="subname" class="form-control"  required value="<?php echo $newsubname; ?>"/>
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>

                                            <div class="form-group">
												<label for="exampleInputEmail1">Select Subject Type</label>
                                                <select  name="subtype" class="form-control" required>
                                                <option value="<?php echo $newsubtype; ?>"><?php if($newsubtype==1)echo "Theory"; else if($newsubtype==0) echo "Practical" ?></option>
                                                <?php
                                                $subject_type = array("0","1");
                                                foreach ($subject_type as $val)
                                                {
                                                    if($val!=$newsubtype)
                                                    {
                                                ?>
                                                <option value="<?php echo $val; ?>"> <?php if($val==1) echo "Theory"; else if($val==0) echo "Practical"; ?> </option>
                                                <?php
                                                    }
                                                }
                                                ?>
                                                ...
                                                <!-- <input type="int" autofocus name="subtype" class="form-control"  required value="<?php echo $newsubtype; ?>"/> -->
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <select name="pName" class="form-control" required>
                                                        ...
                                                        $sql="select * from tbl_program";
                                                                        ...
                                                                        {
                                                            ?>
                                                            <option value="<?php echo $row["pid"]; ?>" <?php if($row['pid']==$newpid){ ?>selected="selected"<?php } ?>> <?php echo $row["pName"] ;?> </option>
                                                            <?php
                                                            }
                                                            }
                                                        ?>  
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <option><?php echo $newsemid; ?></option>
                                                    <?php
                                                    for($i=1;$i<=10;$i++)
                                                    {
                                                    ?>
                                                    ...
                                                    <!-- <input type="int" autofocus name="semid" class="form-control"  required value="<?php echo $newsemid; ?>"/> -->
                                                    <!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
                                            </div>

                                            <div class="form-group">
												<label for="exampleInputEmail1">Enter Hours per Week</label>
                                                <select name="hrs" class="form-control" required>
                                                <option value="<?php echo $newhours;?>">Select Hours</option>
                                                <?php
                                                for($i=1;$i<=10;$i++)
                                                {
                                                ?>
