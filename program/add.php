<?php 
	...
	if (isset($_POST["submit"]))
	{
        ...
        { 
            ...
            $sql_select = "select * from tbl_program where pName='$pname'";
            ...
            {
                $sql = "insert into tbl_program(pName,semesters) values('$pname',$totalsem)";
									...
									<div class="card-body">
										<form action="" method="POST">
											<div class="form-group">
                                                ...
                                                <input type="text" autofocus name="pName" class="form-control" placeholder="Programme name" required />
											</div>
											<div class="form-group">
