...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <?php
                        $sql1="select * from tbl_allocation order by pid, semid";
                        ...
                        <tr>
                            ...
                            <th style="text-align:center;width:1px"><b>Programme</b></th>
                        ...
                        <td style="justify-content:center; text-align:center" width="5%"> 
                            ...
                            <!-- Program -->
                            <?php  
                                $sql2="select pName from tbl_program where pid in (select pid from tbl_allocation where sid=$sid)"; 
                            ...
                            <!-- Batch -->
                            <?php 
                                $sql2="select bName from tbl_batch where bid in (select bid from tbl_allocation where sid=$sid)"; 
                                $result2=$db->query($sql2);
                                if($result2->num_rows>0)
                                        {
                                        while($row2 = $result2->fetch_assoc())
                                    {?>
                                    <td style="justify-content:center; text-align:center" width="15%"> <?php echo $row2["bName"]; ?> </td>
                                    <?php
                                    }
                                }
                            ?>
                            <!-- Semester -->
                            <td style="justify-content:center; text-align:center" width="8%"> <?php echo $row["semid"]; ?> </td>
                            ...
                            <?php  $sql2="select subname from tbl_subject where subid in (select subid from tbl_allocation where sid=$sid)"; 
                                ...
                                if($result2->num_rows>0)
                                {
                                    while($row2 = $result2->fetch_assoc())
                                    {?>
                                    <td style="justify-content:center; text-align:center" width="30%"> <?php echo $row2["subname"]; ?> </td>
                                    <?php
                                    }
                                }
                            ?>
                            ...
                            <?php  $sql2="select fName from tbl_faculty where fid in (select fid from tbl_allocation where sid=$sid)"; 
                                ...
                                if($result2->num_rows>0)
                                    ...
                                    while($row2 = $result2->fetch_assoc())
                                {?>
                                <td style="justify-content:center; text-align:center" width="35%"> <?php echo $row2["fName"]; ?> </td>
                                <?php
                                }}
                            ?>
                            ...
                            <td style="justify-content:center; text-align:center" width="10%"> 
                                ...
                                <?php
                                    ...
                                    <span style="color:maroon" class="glyphicon glyphicon-edit fas fa-lg mt-1 py-2 fa-times" aria-hidden="false"></span>
                                <?php } ?>
                            </td>
