<?php 
	...
	if (isset($_POST["submit"]))
	{
           ...
           {
               $_SESSION['msg'] = "Subject allocation successful!";
...
<head>
    ...
    <script>
        ...
        pid=0;
        sid=0;
        function getbatch(val) { //val is pid
            pid=val;
            $.ajax({
                type: "POST",
                url: "get_batch.php",
									...
									<div class="card-body">
										<form action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select onChange="getbatch(this.value);" name="program" id="program" class="form-control" required>
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                            while( $program_row = $result_program->fetch_assoc())
                                                            { ?>
                                                            <option name="pid" value="<?php echo $program_row['pid'];?>"><?php echo $program_row['pName'];?></option>
                                                            <?php
                                                            }
                                                        }
                                                    ?>   
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="batchlist" id="batchlist" onChange="getsemester(this.value);" class="form-control" required>
													<option value="">Select</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="semlist" id="semlist" onChange="getsubject(this.value);" class="form-control" required>
                                                <option value="">Select</option>
